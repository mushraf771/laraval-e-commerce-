<x-app-layout>
    ...
    <div class=" flex justify-center p-4 min-h-screen m-2 ">
        <div class="shadow-lg border p-5 rounded-md mt-6 bg-white ">
            <p class="mb-0 mr-4 text-3xl font-bold text-center pb-6">
               {{ __('Sign Up')}}
            </p>
            ...
            <form method="POST" action="{{ route('register') }}" autocomplete="false">
                ...
                <div class="relative mb-4">
                    <div class="space-y-2">
                        <div>
                            <label for="name" class="md:w-[350px] text-gray-600 mb-2 block">{{ __('Full Name') }}<span class="text-primary">
                                    *</span></label>
                            <input type="text" type="text" name="name" :value="old('name')"autofocus
                                autocomplete="name"
                        ...
                        <div>
                            <label for="email" class="text-gray-600 mb-2 block"> {{ __('Email') }}
                        ...
                        <div>
                            <label for="phone" class="text-gray-600 mb-2 block">{{ __('Phone') }}
                                <span class="text-primary"> *</span></label>
                            <input type="phone" type="number" name="phone" :value="old('phone')"
                                autocomplete="phone"
                                class="block w-full border rounded border-gray-300 px-4 py-3 text-gray-600 text-sm  focus:ring-0 focus:border-primary placeholder-gray-400"
                                placeholder="923013456789">
                        </div>
                        <div>
                            <label for="address" class="text-gray-600 mb-2 block">{{ __('Address') }}
                                <span class="text-primary"> *</span></label>
