<x-app-layout>
    ...
    <!-- shop wrapper -->
    <div
        class="container px-auto grid grid-cols-1 md:grid-cols-4 gap-6 pt-4 pb-16 items-start  place-content-center mx-auto">
        <!-- sidebar -->
        <div id="filters_navbar" class="col-span-1 hidden md:block  bg-white px-4 pb-6 shadow rounded overflow-hidden">
