<x-guest-layout>
    @if ($sub_categories->count() >= 0)
            ...
            <div class="flex items-center justify-between pb-4">
                ...
                <div class="">
                    <a href="{{ route('dashboard.sub-categories.create') }}"
                        class="p-1 bg-primary text-white">{{ __('Add Sub Category') }}</a>
                </div>
            </div>
                ...
                <tbody>
                    @foreach ($sub_categories as $category)
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <img src="{{ Storage::url($category->image) }}" alt="" class=" w-14 h-16">
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-x-4">
                                    <a href="{{ route('dashboard.sub-categories.edit', $category->id) }}"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                    <form method="POST" onsubmit="return confirm(' Are You Sure...?');"
                                        action={{ route('dashboard.sub-categories.destroy', $category->id) }}>
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
        ...
        <div class="pt-6">
            {{ $sub_categories->onEachSide(5)->links() }}
        </div>
    @else
