    ...
    @if ($product_attributes->count() >= 0)
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-6">
            <div class="flex items-center justify-between pb-4">
                ...
                <div class="">
                    <a href="{{ route('dashboard.product-attributes.create') }}"
                        class="p-1 bg-primary text-white">{{ __('Add attributes') }}</a>
                </div>
            </div>
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-x-4">
                                    <a href="{{ route('dashboard.product-attributes.edit', $attribute->id) }}"
                                        class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                    <form method="POST" onsubmit="return confirm(' Are You Sure...?');"
                                        action={{ route('dashboard.product-attributes.destroy', $attribute->id) }}>
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
        ...
        <div class="pt-6">
            {{ $product_attributes->onEachSide(5)->links() }}
        </div>
    @else
