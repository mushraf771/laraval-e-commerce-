    ...
    <div class="p-4">
        <div class="m-2 grid grid-cols-1 p-4 sm:grid-cols-9 gap-4">
            <div class="col-span-9 shadow rounded-md ">
                <div class="px-4 py-6">
                    <form method="POST" autocomplete="false" action="{{ route('dashboard.brands.update', $brand->id) }}"
                            ...
                            <div class="flex gap-4 justify-between">
                                    ...
                                    @if ($brand->logo != null)
                                        <div class="col-md-2">
                                            <figure class="mt-2" style="width: 80px; height: auto;">
                                                <img src="{{ Storage::url($brand->logo) }}" id="brandLogo"
                                ...
                                <div class="">
                                    ...
                                    <input type="file" id="logo"
                                        name="logo"value="{{ Storage::url($brand->logo) }}"
                            ...
                            <div class="">
                                <label class="flex gap-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    <input
                                        ...
                                        type="checkbox" id="top_brand" name="top_brand" {{ $brand->top_brand == 1 ? 'checked' : '' }}/>Top Brand
                                 </label>
                            </div>
                        </div>
                        <button type="submit"
